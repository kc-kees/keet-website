    ...
    <section class="max-w-4xl mx-auto px-6 pt-16 relative z-10 w-full">
        ...
        <div class="space-y-24 text-lg text-zinc-700 leading-relaxed">
            ...
            <div class="border-l-4 border-amber-500 pl-6 md:pl-8 relative">
                <div class="absolute w-4 h-4 bg-amber-500 rounded-full -left-2.5 top-2 shadow-[0_0_10px_rgba(245,158,11,0.5)]"></div>
                
                <div class="absolute -bottom-24 -left-1 w-1 h-24 bg-linear-to-b from-amber-500 to-orange-600"></div>
            ...
            <div class="border-l-4 border-orange-600 pl-6 md:pl-8 relative">
                <div class="absolute w-4 h-4 bg-orange-600 rounded-full -left-2.5 top-2 shadow-[0_0_10px_rgba(220,38,38,0.5)]"></div>
                
                <div class="absolute -bottom-24 -left-1 w-1 h-24 bg-linear-to-b from-orange-600 to-zinc-900"></div>
                ...
                <div class="bg-zinc-50 p-2 rounded-4xl border border-zinc-100 shadow-lg my-8 transform rotate-1 hover:rotate-0 transition-transform duration-300">
                    <img src="/fotos/keet/vuur-keet.png" alt="De afbraak en het houtvuur" class="rounded-xl w-full aspect-video object-cover" />
